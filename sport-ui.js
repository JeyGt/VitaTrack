...
(function(){
  ...
  const zoneIcons = {
    cardio:`<svg viewBox="0 0 32 32" aria-hidden="true"><path d="M16 27S5 20.6 5 12.5C5 8 10.3 6 16 10.2 21.7 6 27 8 27 12.5 27 20.6 16 27 16 27Z"/><path d="M8 16h4l2-4 3.5 8 2.2-4H24"/></svg>`,
    jambes:`<svg viewBox="0 0 32 32" aria-hidden="true"><path d="M12 5c.7 5 .4 9.4-1 13.5L9 25.2"/><path d="M20 5c-.7 5-.4 9.4 1 13.5l2 6.7"/><path d="M9 25.2c2.3.3 3.9 1.3 4.7 2.8M23 25.2c-2.3.3-3.9 1.3-4.7 2.8"/><path d="M11 18.5 16 20l5-1.5"/></svg>`,
    bras:`<svg viewBox="0 0 32 32" aria-hidden="true"><path d="M7 22c3-1.2 4.6-3.6 5.1-7.1.2-1.6 1.5-2.9 3.1-2.9 1.2 0 2.2.7 2.7 1.8l1 2.4c.4.9 1.2 1.5 2.2 1.5H25c0 5.2-3.9 8.3-9.8 8.3H9.7C8.2 26 7 24.8 7 23.3V22Z"/><path d="M13 15 11 10l3.2-2.3 3 4.8"/></svg>`,
    dos:`<svg viewBox="0 0 32 32" aria-hidden="true"><path d="M12 6c.9 1 2.3 1.6 4 1.6S19.1 7 20 6"/><path d="M11 8.2 8.8 13l2.1 12h10.2l2.1-12L21 8.2"/><path d="M16 8.5V25"/><path d="M12.5 12.2c1 1.2 2.2 1.8 3.5 1.8s2.5-.6 3.5-1.8"/></svg>`,
    abdos:`<svg viewBox="0 0 32 32" aria-hidden="true"><path d="M11 5.5c1.4 1 3 1.5 5 1.5s3.6-.5 5-1.5l1.8 4.6-1.9 16.4H11.1L9.2 10.1 11 5.5Z"/><path d="M13 10.5h6M12.8 15h6.4M12.8 19.5h6.4M16 8.2v18.3"/></svg>`,
    pectoraux:`<svg viewBox="0 0 32 32" aria-hidden="true"><path d="M11.5 6c1.2 1 2.7 1.5 4.5 1.5s3.3-.5 4.5-1.5l3.3 2.5-1.8 15.5H9.9L8.2 8.5 11.5 6Z"/><path d="M9.8 11.8c2.1-1.7 4.2-2 6.2-.3 2-1.7 4.1-1.4 6.2.3"/><path d="M16 10.8v5.8"/></svg>`,
    fullbody:`<svg viewBox="0 0 32 32" aria-hidden="true"><circle cx="16" cy="5.8" r="2.7"/><path d="M16 8.8v8.5"/><path d="M10 13.2 16 10l6 3.2"/><path d="M12.8 27 16 17.3 19.2 27"/><path d="M9.5 20 14 15.2M22.5 20 18 15.2"/></svg>`,
    mobilite:`<svg viewBox="0 0 32 32" aria-hidden="true"><circle cx="21" cy="6" r="2.5"/><path d="m19.5 9-4 4.7-5.2 2.1"/><path d="M15.5 13.7 19.3 18l5.3 1.2"/><path d="m15.5 13.7-.8 7.7-5 5.1"/><path d="M19.3 18 20 26"/></svg>`
  };
  const smallIcons = {
